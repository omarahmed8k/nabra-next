...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8 pt-4">
      <div
        className={`container mx-auto max-w-6xl rounded-4xl lg:rounded-full transition-all duration-500 ${
          scrolled
        ...
        <nav className="px-4 md:ps-6 md:px-2 py-2">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-2 xl:gap-3">
              {[
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className={`relative px-2 xl:px-3 py-2 text-xs xl:text-sm font-medium transition-all duration-300 rounded-full group whitespace-nowrap ${
                    pathname === item.href
                      ? "text-[#f900fe]"
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 bg-[#f900fe] transition-all duration-300 ${
                      pathname === item.href
                        ? "w-[calc(100%-1rem)] xl:w-[calc(100%-1.5rem)] opacity-100"
                        : "w-0 opacity-0 group-hover:w-[calc(100%-1rem)] xl:group-hover:w-[calc(100%-1.5rem)] group-hover:opacity-100"
                    }`}
                  />
                </Link>
              ))}
              ...
              <Link
                href="/contact"
                className="ml-1 xl:ml-2 px-4 xl:px-8 py-2 xl:py-2.5 text-xs xl:text-sm font-semibold bg-[#f0f0f0] text-black rounded-full hover:bg-white transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 whitespace-nowrap"
              >
                {t("cta.letsTalk")}
              </Link>
              ...
              <div className="relative ml-1 flex items-center rounded-full p-1 border border-black/20">
                <button
                  ...
                  className={`px-2 xl:px-3 py-1.5 text-xs font-medium rounded-full transition-all duration-300 cursor-pointer ${
                    locale === "en"
            ...
            <button
              ...
              className="lg:hidden p-2 text-[#f0f0f0] hover:bg-white/5 rounded-lg transition-all duration-300"
